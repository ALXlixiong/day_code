...
Baseclient :: STATUS Baseclient :: parse_address()
{
    ...
    *get++ = '\0';
    ...
    std::cout<<"path:"<<myfile_information.file_path<<std::endl;
    ...
    std::cout<<"name:"<<myfile_information.file_name<<std::endl;
    ...
    std::cout<<"tdname:"<<myfile_information.file_name_td<<std::endl;
    return HTTP;
}
...
void Baseclient :: thread_download()
{
    ...
    for(i=0; i<thread_number; i++)
    {
        ...
        pthread_create(&Thread_package[i].pid, NULL, work, (void *)&Thread_package[i]);
...
void Baseclient :: mysocket()
{
    ...
    /*填充HTTP请求头*/
    cout<<"address_buf:"<<address_buf<<endl;
    cout<<"fqdn:"<<fqdn<<endl;
    //Host作用：http://www.cplusplus.com/reference/string/string/copy/
